...
describe('Bullet List', function () {
    ...
    it('should not allow empty bullet lists', function () {
    ...
    describe('item', function () {
        ...
        it('should create a valid bullet list with a single entry', function () {
            var doc = new index_1.Document();
        ...
        it('should create a valid bullet list with multiple entries', function () {
            var doc = new index_1.Document();
            var list = doc.bulletList();
...
//# sourceMappingURL=bullet-list.spec.js.map